...
python run_model.py --learning_rate $LR --do_train --do_validation --data_dir $DATA_FT_DIR --output_dir WIC_DWUG+XLWSD+CoMeDi_without_chinese_4_lr$LR --gradient_accumulation_steps $grad_acc_steps \
