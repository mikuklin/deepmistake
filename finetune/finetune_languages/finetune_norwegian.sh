...
python run_model.py  --do_train --do_validation --data_dir $DATA_FT_DIR --output_dir WIC_DWUG+XLWSD+CoMeDi_norwegian_4 --gradient_accumulation_steps $grad_acc_steps \
