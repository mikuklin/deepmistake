...
train_epochs=50
ft_epochs=50
DATA_FT_DIR=comedi_dataset_without_language/swedish
...
python run_model.py  --do_train --do_validation --data_dir $DATA_FT_DIR --output_dir WIC_DWUG+XLWSD+CoMeDi_without_swedish_4 --gradient_accumulation_steps $grad_acc_steps \
